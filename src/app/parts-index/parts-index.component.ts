...
@Component({
  selector: 'app-parts-index',
  templateUrl: './parts-index.component.html',
  styleUrls: ['./parts-index.component.css']
})
export class PartsIndexComponent implements OnInit {
